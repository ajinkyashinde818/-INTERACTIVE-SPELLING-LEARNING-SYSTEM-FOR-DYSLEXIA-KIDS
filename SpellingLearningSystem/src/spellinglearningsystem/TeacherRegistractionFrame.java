 ...
 * @author HP
 */
public class TeacherRegistractionFrame extends javax.swing.JFrame {

    /**
     * Creates new form ClientRegistractionFrame
     */
    public TeacherRegistractionFrame() {
        super("Teacher Registraction Frame");
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBounds(790, 180, 730, 730);

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 80)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(30, 58, 95));
        jLabel3.setText("Teacher Registraction");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(760, 30, 780, 100);

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Teacher Registraction.png"))); // NOI18N
        getContentPane().add(jLabel6);
        jLabel6.setBounds(0, 0, 1870, 1060);
